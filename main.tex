...
\begin{center}
    {\Huge \scshape MD SAMER ANSARI} \\ \vspace{4pt}
   \vspace{1pt}
    \small \raisebox{-0.1\height}\faPhone\ +91 6375104026 ~ \href{mailto:mdsameransari45@gmail.com}{\raisebox{-0.2\height}\faEnvelope\  \underline{mdsameransari45@gmail.com}} ~ 
    \href{https://linkedin.com/in/mrsamirr/}{\raisebox{-0.2\height}\faLinkedin\ \underline{linkedin.com/in/mrsamirr}}  ~
    \href{https://github.com/mrsamirr}{\raisebox{-0.2\height}\faGithub\ \underline{github.com/mrsamirr}}
    \vspace{-8pt}
\end{center}
...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      {ASANSOL ENGINEERING COLLEGE}{Nov. 2022 -- June 2026}
      {Bachelor of Technology in Computer Science and Engineering}{Asansol, West Bengal}
 ...
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     \textbf{Languages}{:  C, C++, Java, Python, JavaScript} \\
      \textbf{Technologies/Frameworks}{: React js, Express js, Node js, Tailwind, Recoil} \\
